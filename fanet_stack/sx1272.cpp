...
void Sx1272::sx1272_setSyncWord(uint8_t sw)
{
    setOpMode(LORA_STANDBY_MODE);
    writeRegister(REG_SYNCWORD_LORA, sw);
}

void Sx1272::sx1272_setLnaGain(uint8_t gain, bool lnaboost)
{
    /* store state */
    uint8_t opmode = getOpMode();
